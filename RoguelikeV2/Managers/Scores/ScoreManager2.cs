...
namespace RoguelikeV2.Managers.Scores
{
    ...
    {
        private static string fileName = "scores2.xml";
        ...
        public ScoreManager2() : this(new List<ScoreProperties>())
        {

        }

        public ScoreManager2(List<ScoreProperties> scores)
        {
            Scores = scores;
            UpdateHighscores();
        ...
        public static ScoreManager2 Load()
        {
            ...
            using (var reader = new StreamReader(new FileStream(fileName, FileMode.Open)))
            {
                ...
                return new ScoreManager2(scores);
            }
        ...
        public static void Save(ScoreManager2 scoreManager)
        {
